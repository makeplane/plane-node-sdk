...
import {
  ...
  ListInitiativeLabelsParams,
} from "../../models/InitiativeLabel";
...
export class Labels extends BaseResource {
  ...
  async update(
    ...
    initiativeLabelId: string,
    updateInitiativeLabel: UpdateInitiativeLabel
  ): Promise<InitiativeLabel> {
    return this.patch<InitiativeLabel>(
      `/workspaces/${workspaceSlug}/initiatives/labels/${initiativeLabelId}/`,
      updateInitiativeLabel
    );
  }
  ...
  async addLabels(
    workspaceSlug: string,
    initiativeId: string,
    addLabels: AddInitiativeLabelsRequest
  ): Promise<InitiativeLabel[]> {
  ...
  async removeLabels(
    workspaceSlug: string,
    initiativeId: string,
    removeLabels: RemoveInitiativeLabelsRequest
  ): Promise<void> {
  ...
  async listLabels(
    ...
    return this.get<PaginatedResponse<InitiativeLabel>>(
      `/workspaces/${workspaceSlug}/initiatives/${initiativeId}/labels/`,
      params
    );
  }
}
