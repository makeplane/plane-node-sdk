...
export function instanceOfTimezoneEnum(value: any): boolean {
    for (const key in TimezoneEnum) {
        if (Object.prototype.hasOwnProperty.call(TimezoneEnum, key)) {
            if (TimezoneEnum[key as keyof typeof TimezoneEnum] === value) {
                return true;
            }
        }
    }
...
export function TimezoneEnumFromJSON(json: any): TimezoneEnum {
    return TimezoneEnumFromJSONTyped(json, false);
}

export function TimezoneEnumFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimezoneEnum {
    return json as TimezoneEnum;
}

export function TimezoneEnumToJSON(value?: TimezoneEnum | null): any {
    return value as any;
}

export function TimezoneEnumToJSONTyped(value: any, ignoreDiscriminator: boolean): TimezoneEnum {
    return value as TimezoneEnum;
}
